# MelodicMind AI Chatbot

This forks, modifies, and fine tunes the Vercel AI Chatbot interface, with a custom GPT tuned data stream. 

## Vercel OpenAI Chatbot Example
